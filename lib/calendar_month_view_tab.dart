...
class _CalendarMonthViewTabState extends State<CalendarMonthViewTab> with AutomaticKeepAliveClientMixin<CalendarMonthViewTab> {
  @override
  ...
  void initState() {
    super.initState();
    _viewModel = CalendarMonthViewModel(context, initialDate: widget.displayDate); // Changed
        ...
        children: days.asMap().entries.map((entry) {
          ...
          return Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                border: isLast ? null : Border(right: BorderSide(color: theme.dividerColor)),
              ),
              child: Text(
                day,
                      ...
                      child: ListView(
                        children: [
                          SizedBox(
                            ...
                            child: MonthGridCalendar( // Changed to MonthGridCalendar
